...
define gui.accent_color = '#607D8B'      # 改为蓝灰色

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#90A4AE'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#aaaaaa'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#607D8B'
...
## 游戏内文本使用的字体。
define gui.text_font = "AlibabaPuHuiTi-2-75-SemiBold.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "AlibabaPuHuiTi-2-75-SemiBold.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "AlibabaPuHuiTi-2-75-SemiBold.ttf"
...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = "images/gui/main_menu.jpg"
